...
.controller('ClientRestrictConfigurationMainController', ['$scope', '$controller', 'Client', 'ClientRestrictConfigurationsService',
    function ($scope, $controller, Client, ClientRestrictConfigurationsService) {
         ...
         */
        $scope.save = function(clientRestrictConfigurationForm){
            $scope.clientRestrictConfigurationForm = true;
            ClientRestrictConfigurationsService.save($scope.clientRestrictConfiguration).then(function(response){
