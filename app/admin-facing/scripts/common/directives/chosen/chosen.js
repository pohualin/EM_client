        ...
        .directive('chosen', ['$timeout', '$parse', '$document', function ($timeout, $parse, $document) {
            ...
            return {
                ...
                link: function (scope, element, attr, ngModel) {
                    var chosen, defaultText, disableWithMessage, empty, initOrUpdate, match, options, origRender, removeEmptyMessage, startLoading, stopLoading, valuesExpr;
                    ...
                    disableWithMessage = function () {
                        empty = true;
                        var noResultsText = element.attr('data-no-results-placeholder');
                        if (!noResultsText){
                            noResultsText = defaultText;
                        }
                        return element.attr('data-placeholder', noResultsText).attr('disabled', true)
