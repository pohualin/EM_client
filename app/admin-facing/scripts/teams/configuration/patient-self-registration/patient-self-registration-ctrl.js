                    ...
                    angular.forEach(response.content, function (translation) {
                        angular.forEach($scope.languagesAvailable, function (language) {
                            if (language.entity.languageTag === translation.entity.language.languageTag && translation.entity.language.languageTag === 'en') {
                                ...
                                $scope.idLabelConfigEnglish.config.entity.value = type.isModifiable && $scope.originalIdLabelConfigEnglish ? $scope.originalIdLabelConfigEnglish.entity.value : translation.entity.value;
                                ...
                                $scope.idLabelConfigSpanish.config.entity.value = type.isModifiable && $scope.originalIdLabelConfigSpanish ? $scope.originalIdLabelConfigSpanish.entity.value : translation.entity.value;
