    ...
    .config(function ($routeProvider, USER_ROLES, MENU) {
        ...
        $routeProvider
            .when('/clients/:clientId/users', {
                templateUrl: 'admin-facing/partials/user/client/main.html',
                ...
                templateUrl: 'admin-facing/partials/user/client/metadata/new.html',
                ...
                templateUrl: 'admin-facing/partials/user/client/editor.html',
