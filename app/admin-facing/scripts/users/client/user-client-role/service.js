...
angular.module('emmiManager')
    ...
    .service('UserClientUserClientRolesService', ['$q', '$http', 'UriTemplate', 'CommonService',
            ...
            return {
                ...
                deleteUserClientUserClientRole: function (existingUserClientUserClientRole) {
                    return $http.delete(UriTemplate.create(existingUserClientUserClientRole.link.userClientUserClientRole)
                        .stringify({userClientUserClientRoleId: existingUserClientUserClientRole.entity.id}))
                        .then(function () {
                            allPermissions = [];
                        });
                },
